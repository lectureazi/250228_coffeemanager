...
public class SeasonCoffee extends Coffee{
	...
	public SeasonCoffee(String name, int price, int purchasePrice, int stock, int safetyStock, List<Month> seasonMonths) {
	...
	public boolean isSeason() {
		...
		if(seasonMonths.contains(nowMonth)) return true;
		return false;
	}
